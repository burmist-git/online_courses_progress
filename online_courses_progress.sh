...
function printHelp {
    ...
    echo " [0] -push_ml_nj01   : example of the push "
    echo " [1]                 : unixtime "
    echo " [0] -plot_ml_nj01   : example of the plot "
    echo " [0] -push_pyml_jp01 : example of the push "
    echo " [1]                 : unixtime "
    echo " [0] -plot_pyml_jp01 : example of the plot "
    echo " [0] -h              : print help"
}
